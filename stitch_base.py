...
def energyid_cycle_Calc_2(edge1, edge2):
    """
    Prend en entrée deux lignes (type liste) 
...
def selectCorrectPatchPattern_3(edge1, edge2):
    ...
    """
    print(f"edge1 : point 1 {edge1[0]} / {liste_adjacence[edge1[0]]} / {liste_points[edge1[0]]}, point 2 {edge1[1]} / {liste_adjacence[edge1[1]]} / {liste_points[edge1[1]]}")
    print(f"edge2 : point 1 {edge2[0]} / {liste_adjacence[edge2[0]]} / {liste_points[edge2[0]]}, point 2 {edge2[1]} / {liste_adjacence[edge2[1]]} / {liste_points[edge2[1]]}")
    """
